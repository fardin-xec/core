...
class UnifierRESTService {
    ...
    async updateBPRecord(bp, options) {
        var _a, _b, _c, _d, _e;
        try {
            ...
            if (((_a = bp.workflow) === null || _a === void 0 ? void 0 : _a.currentStepName) && ((_b = bp.workflow) === null || _b === void 0 ? void 0 : _b.action)) {
                _options.workflow_details = {
                    WFCurrentStepName: (_c = bp.workflow) === null || _c === void 0 ? void 0 : _c.currentStepName,
                    WFActionName: (_d = bp.workflow) === null || _d === void 0 ? void 0 : _d.action
                };
            }
            ...
            if (resp.data.status !== 200) {
                throw {
                    message: 'Unifier update failed. Cause: ' + String((_e = resp.data) === null || _e === void 0 ? void 0 : _e.message),
                    data: resp.data
                };
            }
            return resp.data;
