   ...
   */
    async getShells(shellType = 'Projects', options = {}) {
        ...
        try {
            ...
            if (resp.data.status !== 200) {
                throw new Error('Failed to fetch shells: ' + ((_b = (_a = resp.data) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.toString()));
            }
            return resp.data.data || [];
        }
        catch (e) {
    ...
    async getWBS(projectNumber, options = {}) {
        ...
        try {
            ...
            if (resp.data.status !== 200) {
                throw new Error('Failed to fetch WBS records: ' + ((_b = (_a = resp.data) === null || _a === void 0 ? void 0 : _a.message) === null || _b === void 0 ? void 0 : _b.toString()));
            }
            return resp.data.data || [];
        }
        catch (e) {
